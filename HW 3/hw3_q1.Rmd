...
```{r, echo=FALSE, fig.height=5.32, fig.width=8}
hp <- df %>%
  ggplot() +
...
We see that the accuracy values oscillate pretty heavily between 82% and 86%. I suspect that one of the major reasons that the graph is so scattered and up-and-down has to do with the limited testing and training datasets, with only 294 rows in the training dataset.
